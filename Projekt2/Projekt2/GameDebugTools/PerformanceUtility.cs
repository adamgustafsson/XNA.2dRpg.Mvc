...
namespace PerformanceUtility
{
    ...
    public class PerformanceUtility
    {
        ...
        public PerformanceUtility(GraphicsDeviceManager a_graphics, Game a_game)
        {
            this.Initialize(a_game);
            graphics = a_graphics;
            game = a_game;
#if WINDOWS_PHONE
        ...
        internal void LoadContent(ContentManager a_content, SpriteBatch a_spriteBatch)
        {
            // create our SpriteBatch and load our font
            spriteBatch = a_spriteBatch;
            font = a_content.Load<SpriteFont>("Fonts/DebugFont");
        ...
        internal void RecordUpdateStart(GameTime gameTime)
        {
        ...
        internal void RecordUpdateEnd(GameTime gameTime)
        {
            // Stop measuring time for "Update".
            debugSystem.TimeRuler.EndMark("Update");
        }

        internal void RecordDrawStart(GameTime gameTime)
        {
            ...
            Layout layout = new Layout(graphics.GraphicsDevice.Viewport);
        ...
        internal void RecordDrawEnd(GameTime gameTime)
        {
        ...
        void HandleInput()
        {
            ...
            if (IsButtonOrKeyPressed(Buttons.A, Keys.S))
            {
